                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST" action="{{ action('ShortController@postRegister') }}">
                                        ...
                                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input id="description" type="text" class="form-control" name="description" required> @if ($errors->has('description'))
                                                <span class="help-block">
                                        ...
                                        <div class="form-group{{ $errors->has('established') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input id="established" type="text" class="form-control" name="established" required> @if ($errors->has('established'))
                                                <span class="help-block">
                                        ...
                                        <div class="form-group{{ $errors->has('location') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input id="location" type="text" class="form-control" name="location" required> @if ($errors->has('location'))
                                                <span class="help-block">
                                        ...
                                        <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                {{Form::select('type',$provider_types, null, ['placeholder' => 'Select a type...'])}} @if ($errors->has('type'))
                                                <span class="help-block">
