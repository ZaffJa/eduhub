            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image" >
                        <img style="border-radius:5px" src="../img/{{isset(Auth::user()->short_provider) ? Auth::user()->short_provider->profilePic->path : ''}}" onerror="this.onerror=null;this.src='/img/avatar/boy-512-03.png'" alt="User Image">
                    </div>
