                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img class="profile-pic" id="clickImg" src="{{isset(Auth::user()->short_provider) ? env('AWS_S3').Auth::user()->short_provider->profilePic->path : ''}}" onerror="this.onerror=null;this.src='/img/avatar/boy-512-03.png'" />
                                    <p>
                                        {{Auth::user()->name}}
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image" >
                        <img style="border-radius:5px" src="{{isset(Auth::user()->short_provider->profilePic) ? env('AWS_S3').Auth::user()->short_provider->profilePic->path : ''}}" onerror="this.onerror=null;this.src='/img/avatar/boy-512-03.png'" alt="User Image">
                    </div>
