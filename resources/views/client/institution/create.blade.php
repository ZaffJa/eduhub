                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="email"
                                               placeholder="To add more emails just add ';' between email. eg: test@email.com;test2@email.com"
                                               value="{{old('email')}}">
                                    </div>
                                    <div class="form-group">
                                        <label>Public Relation Department Email</label>
                                        <input type="text" class="form-control" name="public_relations_department_email"
                                               placeholder="To add more emails just add ';' between email. eg: test@email.com;test2@email.com"
                                               value="{{old('public_relations_department_email')}}">
                                    </div>
                                    <div class="form-group">
                                        <label>Student Enrollment Department Email</label>
                                        <input type="text" class="form-control"
                                               name="student_enrollment_department_email"
                                               placeholder="To add more emails just add ';' between email. eg: test@email.com;test2@email.com"
                                               value="{{old('student_enrollment_department_email')}}">
                                    </div>
                                    <div class="form-group">
                                        <label>Corporate Communication Department Email</label>
                                        <input type="text" class="form-control"
                                               name="corporate_communications_department_email"
                                               placeholder="To add more emails just add ';' between email. eg: test@email.com;test2@email.com"
                                               value="{{old('corporate_communications_department_email')}}">
                                    </div>
                                    <div class="form-group">
                                        <label>Marketing Department Email</label>
                                        <input type="text" class="form-control" name="marketing_department_email"
                                               placeholder="To add more emails just add ';' between email. eg: test@email.com;test2@email.com"
                                               value="{{old('marketing_department_email')}}">
                                    </div>
