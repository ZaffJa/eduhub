@extends('client.layout.headerLayout') @section('title', 'Scholarship') @section('headbar', 'Edit Scholarship') @section('content2')
        ...
        <div class="box">
            <div class="box-body" style="font-size:125%">
                <dl class="dl-horizontal">
                    ...
                    <hr>
                    <dt>Created at</dt>
                    <dd> {{$scholarship->created_at->diffForHumans()}} </dd>
                    <hr>
                </dl>
                <button type="button" name="edit_scholarship" id="btn_edit_scholarship" class="btn btn-success">Edit</button>
            </div>
        </div>
    </div>
</div>
...
<div class="box" id="edit_scholarship" style="display:none">
    <div class="box-body">
        <fieldset>
            ...
            <form role="form" method="post" action="{{action('ScholarshipController@clientUpdate',$scholarship->id)}}" autocomplete="off" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    {{Form::select('status',['0'=>'Active','1'=>'Inactive'],$scholarship->status,['id'=>'type-id'])}}
                </div>

                <div class="form-group">
                    <input name="file_form" type="file" required="">
                </div>
