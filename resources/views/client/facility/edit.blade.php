...
@section('content2')
            ...
            <fieldset>
                ...
                <form method="post" enctype="multipart/form-data" class="confirmLeaveBeforeSave">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <textarea type="text" name="faci_capacity"
                                      placeholder="Details">{!! $facility->capacity !!}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-1">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{!! route('faci.update', array($typeid, $facility->id)) !!}">
    ...
    <script>
        $(document).ready(function () {
            ...
            CKEDITOR.replace('faci_capacity', {
                height: ['150px']
