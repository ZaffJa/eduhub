...
@section('title', 'Dashboard')
      ...
      <div class="col-md-12">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-purple-active">
              <i
              <!-- <h3 class="widget-user-username">asdasd</h3><!--University name-->
              ...
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header">asdasd</h5>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <a href="/client-dashboard/facilities">
          <div class="box-body">
            <div class="demo-card-image mdl-card mdl-shadow--1dp" style="background-image: url('/img/default/dumbbell-03.png'); background-size: contain; background-color:white;">
              <div class="mdl-card__title mdl-card--expand"  >
