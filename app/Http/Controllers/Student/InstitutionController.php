...
//        $courses =  $this->recommendedCourse($spmCourseRequirement,$userSpmSubject);
        $institutions = Institution::where('enrollment_status',1)->get();
    ...
    /**
     * Get all course requirements by institutions and compare with
     * students results. If students result higher than
     * institutions recommended grade then
     * return course.
     *
